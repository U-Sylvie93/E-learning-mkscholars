<x-dashboard-layout role="student" title="Student Dashboard" description="MK Scholars student dashboard.">
    <div class="space-y-6">
        <x-section-header
            ...
            description="A protected workspace for courses, progress tracking, assignments, payments, and study plans."
        />
        ...
        <x-card data-testid="student-dashboard-card" class="min-w-0">
            ...
            <h3 class="mt-5 text-xl font-bold text-mk-navy">Student files</h3>
            <p class="mt-3 text-sm leading-6 text-slate-600">Upload reusable CVs, transcripts, letters, and study documents for your student profile.</p>
